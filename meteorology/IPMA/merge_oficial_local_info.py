...
from __configure__.paths import IPMA_STATIONS_CSV, IPMA_STATIONS_OFICIAL_CORRECTED, IPMA_STATIONS_OFFICIAL, IPMA_STATIONS_MERGED, IPMA_STATIONS_CONFLICT, IPMA_STATIONS_DONT_MATCH, IPMA_CONFLICT_MAPS, IPMA_MERGED_MAPS, IPMA_MERGED_MAPS_DIST
